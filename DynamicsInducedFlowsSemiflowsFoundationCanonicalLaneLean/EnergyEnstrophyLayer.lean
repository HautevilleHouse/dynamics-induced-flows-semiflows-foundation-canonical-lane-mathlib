import DynamicsInducedFlowsSemiflowsFoundationCanonicalLaneLean.LerayHopfWeakLayer
...
def EnergyEnstrophyClosed (C : EnergyEnstrophyCertificate) : Prop :=
  ...
  C.enstrophyCoercivity ∧ C.captureBudget ∧ C.compactnessModulus ∧ C.coherenceFloor ∧ C.registryClosed
